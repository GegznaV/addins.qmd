...
[![GitHub version](https://img.shields.io/badge/GitHub-`r packageVersion("addins.qmd")`-brightgreen.svg)](https://github.com/GegznaV/addins.qmd)
...
Package `addins.qmd` is an *R* package that provides a set of *RStudio* add-ins for *R Markdown*. The main purpose of this package is to alleviate learning process of *R Markdown* syntax. 
